...
public class UIManager : MonoBehaviour
{
    ...
    private void StartQuestDialouge(Quest quest)
    {
    ...
    private void SetupDialoguePanel(Npc npc)
    {
        ...
        {
            Quest newQuset = QuestManager.instance.CheckForQuest(npc, QuestStatus.New);

            if (newQuset != null)
                StartQuestDialouge(newQuset);
        }
    }
    ...
    public void SelectHeroByAvatar(int i)
    {
        ...
        {
            PartyManager.instance.SelectingSingleHeroByToggle(i);
        }
        else
        {
    ...
    public void ShowCharPanel()
    {
        ...
        Hero hero = (Hero)PartyManager.instance.SelectChar[0];
